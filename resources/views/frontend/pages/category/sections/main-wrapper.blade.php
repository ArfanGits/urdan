                    ...
                    <div class="shop-topbar-wrapper mb-40">
                        ...
                        <div class="shop-topbar-right" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="shop-view-mode nav">
                                ...
                                <a href="#shop-2" data-bs-toggle="tab" class=""><i
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-5">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="asset/frontend/assets/images/product/product-5.png" alt="Product Style">
                                                </a>
                                        ...
                                        <div class="col-lg-8 col-sm-7">
                                            <div class="shop-list-content">
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent
                                                    tristique bibend est a fermentum. Cras faucibus ex quis justo
                                                    consectetur eleifend in eget diam.</p>
                                ...
                                <div class="shop-list-wrap mb-30">
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-5">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="asset/frontend/assets/images/product/product-7.png" alt="Product Style">
                                                </a>
                                                <div class="product-list-quickview">
                                                    <button class="product-action-btn-2" title="Quick View"
                                                        data-bs-toggle="modal" data-bs-target="#exampleModal">
                                ...
                                <div class="shop-list-wrap mb-30">
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-5">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="asset/frontend/assets/images/product/product-4.png" alt="Product Style">
                                                </a>
                                                <div class="product-list-badge badge-right badge-pink">
                                                    <span>-10%</span>
                                                </div>
                                ...
                                <div class="shop-list-wrap mb-30">
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-5">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="asset/frontend/assets/images/product/product-8.png" alt="Product Style">
                                                </a>
                                                <div class="product-list-badge badge-right badge-pink">
                                                    <span>-10%</span>
                                                </div>
