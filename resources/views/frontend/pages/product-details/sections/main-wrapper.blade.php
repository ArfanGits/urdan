        ...
        <div class="sidebar-cart-all">
            ...
            <div class="cart-content">
                ...
                <ul>
                    <li>
                        <div class="cart-img">
                            <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/cart/cart-1.jpg" alt=""></a>
                        </div>
                        <div class="cart-title">
                            <h4><a href="{{route('product-details')}}">Stylish Swing Chair</a></h4>
                            <span> 1 × $49.00 </span>
                        </div>
                    ...
                    <li>
                        <div class="cart-img">
                            <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/cart/cart-2.jpg" alt=""></a>
                        </div>
                        <div class="cart-title">
                            <h4><a href="{{route('product-details')}}">Modern Chairs</a></h4>
                            <span> 1 × $49.00 </span>
                        </div>
                        <div class="cart-delete">
                            <a href="#">×</a>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="asset/frontend/assets/images/product-details/pro-details-small-img-1.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="asset/frontend/assets/images/product-details/pro-details-small-img-2.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="asset/frontend/assets/images/product-details/pro-details-small-img-3.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="asset/frontend/assets/images/product-details/pro-details-small-img-4.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product-details-small-img">
                                            <img src="asset/frontend/assets/images/product-details/pro-details-small-img-5.png"
                                                alt="Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="asset/frontend/assets/images/product-details/pro-details-zoom-img-1.png">
                                                <img src="asset/frontend/assets/images/product-details/pro-details-large-img-1.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <a class="easyzoom-pop-up img-popup"
                                            href="asset/frontend/assets/images/product-details/pro-details-large-img-1.png">
                                    ...
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="asset/frontend/assets/images/product-details/pro-details-zoom-img-2.png">
                                                <img src="asset/frontend/assets/images/product-details/pro-details-large-img-2.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <a class="easyzoom-pop-up img-popup"
                                            href="asset/frontend/assets/images/product-details/pro-details-large-img-2.png">
                                            <i class="pe-7s-search"></i>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="asset/frontend/assets/images/product-details/pro-details-zoom-img-3.png">
                                                <img src="asset/frontend/assets/images/product-details/pro-details-large-img-3.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <a class="easyzoom-pop-up img-popup"
                                            href="asset/frontend/assets/images/product-details/pro-details-large-img-3.png">
                                            <i class="pe-7s-search"></i>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="asset/frontend/assets/images/product-details/pro-details-zoom-img-4.png">
                                                <img src="asset/frontend/assets/images/product-details/pro-details-large-img-4.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <a class="easyzoom-pop-up img-popup"
                                            href="asset/frontend/assets/images/product-details/pro-details-large-img-4.png">
                                            <i class="pe-7s-search"></i>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="asset/frontend/assets/images/product-details/pro-details-zoom-img-5.png">
                                                <img src="asset/frontend/assets/images/product-details/pro-details-large-img-5.png"
                                                    alt="">
                                            </a>
                                        </div>
                                        <a class="easyzoom-pop-up img-popup"
                                            href="asset/frontend/assets/images/product-details/pro-details-large-img-5.png">
                                            <i class="pe-7s-search"></i>
                                        </a>
                                    </div>
                                </div>
