            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="intro-section slider-height-1 slider-content-center bg-img single-animation-wrap slider-bg-color-1"
                        style="background-image:url(asset/frontend/assets/images/slider/slider-bg-1.jpg)">
                        <div class="container">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="hero-slider-img-1 slider-animated-1">
                                        <img class="animated animated-slider-img-1"
                                            src="asset/frontend/assets/images/slider/slider-img-1.png" alt="">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="hero-slider-img-1 slider-animated-1">
                                        <img class="animated animated-slider-img-1"
                                            src="asset/frontend/assets/images/slider/slider-img-1-2.png" alt="">
                                        <div class="product-offer animated">
                                            <h5>30% <span>Off</span></h5>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/banner/banner-1.png"
                                alt=""></a>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="400">
                        <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/banner/banner-2.png"
                                alt=""></a>
                        <div class="banner-content-1">
                            <h5>new arrival</h5>
                            <h3>Hanging Chair</h3>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="600">
                        <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/banner/banner-3.png"
                                alt=""></a>
                        <div class="banner-content-1">
                            <h5>new arrival</h5>
                            <h3>Folding Chair</h3>
            ...
            <div class="section-border section-border-margin-1" data-aos="fade-up" data-aos-delay="200">
                <div class="section-title-timer-wrap bg-white">
                    ...
                    <div id="timer-1-active" class="timer-style-1">
                        <span>End In: </span>
                        <div data-countdown="2022/12/22"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-7">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/banner/banner-4.png"
                                alt=""></a>
                ...
                <div class="col-lg-5 col-md-5">
                    <div class="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="400">
                        <a href="{{route('product-details')}}"><img src="asset/frontend/assets/images/banner/banner-5.png"
                                alt=""></a>
                        <div class="banner-content-3">
                            <h3>Up To 30% <img src="asset/frontend/assets/images/icon-img/sale.png" alt=""> Every
                                Item</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="home-single-product-img" data-aos="fade-up" data-aos-delay="200">
                        <a href="{{route('product-details')}}"><img
                                src="asset/frontend/assets/images/product/single-product.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                        <div class="blog-img-date-wrap mb-25">
                            <div class="blog-img">
                                <a href="blog-details.html"><img src="asset/frontend/assets/images/blog/blog-1.png"
                                        alt=""></a>
                            </div>
                            <div class="blog-date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrap mb-30" data-aos="fade-up" data-aos-delay="400">
                        <div class="blog-img-date-wrap mb-25">
                            <div class="blog-img">
                                <a href="blog-details.html"><img src="asset/frontend/assets/images/blog/blog-2.png"
                                        alt=""></a>
                            </div>
                            <div class="blog-date">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrap mb-30" data-aos="fade-up" data-aos-delay="600">
                        <div class="blog-img-date-wrap mb-25">
                            <div class="blog-img">
                                <a href="blog-details.html"><img src="asset/frontend/assets/images/blog/blog-3.png"
                                        alt=""></a>
                            </div>
                            <div class="blog-date">
