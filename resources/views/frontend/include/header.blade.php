                                ...
                                <li><a href="{{route('category')}}">SHOP</a>
                                    <ul class="mega-menu-style mega-menu-mrg-1">
                                        <li>
                                            <ul>
                                                <li>
                                                    <a class="dropdown-title" href="{{route('category')}}">Shop Layout</a>
                                                    <ul>
                                                        <li><a href="{{route('category')}}">standard style</a></li>
                                                        <li><a href="{{route('category')}}">shop grid sidebar</a></li>
                                                        <li><a href="{{route('category')}}">shop list style</a></li>
                                                        <li><a href="{{route('category')}}">shop list sidebar</a></li>
                                                        <li><a href="{{route('category')}}">shop right sidebar</a></li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="{{route('product-details')}}">tab style 1</a></li>
                                                        <li><a href="{{route('product-details')}}">tab style 2</a></li>
                                                        <li><a href="{{route('product-details')}}">gallery style </a></li>
                                                        <li><a href="{{route('product-details')}}">affiliate style</a></li>
                                                        <li><a href="{{route('product-details')}}">group style</a></li>
                                                        <li><a href="{{route('product-details')}}">fixed image style </a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a href="{{route('category')}}"><img src="asset/frontend/assets/images/banner/menu.png" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
