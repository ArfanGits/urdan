                ...
                <div class="row gx-0">
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="modal-img-wrap">
                            <img src="asset/frontend/assets/images/product/quickview.png" alt="">
                        </div>
                    </div>
    ...
    <div class="off-canvas-wrap">
        ...
        <div class="language-currency-wrap language-currency-wrap-modify">
            ...
            <div class="language-wrap">
                <a class="language-active" href="#"><img src="asset/frontend/assets/images/icon-img/flag.png" alt="">
                    English <i class=" ti-angle-down "></i></a>
                <div class="language-dropdown">
                    <ul>
                        <li><a href="#"><img src="asset/frontend/assets/images/icon-img/flag.png" alt="">English </a>
                        </li>
                        <li><a href="#"><img src="asset/frontend/assets/images/icon-img/spanish.png" alt="">Spanish</a>
                        </li>
                        <li><a href="#"><img src="asset/frontend/assets/images/icon-img/arabic.png" alt="">Arabic </a>
                        </li>
                    </ul>
                </div>
            </div>
