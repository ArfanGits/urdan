                            ...
                            <table class="table table-striped m-t-20 visitors-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/us.png" />USA
                                        </td>
                                        <td>755</td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/Canada.png" />Canada
                                        </td>
                                        <td>700</td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/India.png" />India
                                        </td>
                                        <td>410</td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/Australia.png" />Australia
                                        </td>
                                        <td>304</td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/Singapore.png" />Singapore
                                        </td>
                                        <td>203</td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/uk.png" />UK
                                        </td>
                                        <td>202</td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <td>
                                            <img class="m-r-10"
                                                src="asset/backend/assets/img/flags/UAE.png" />UAE
                                        </td>
                                        <td>180</td>
                                        <td>
                                            <div class="progress">
                            ...
                            <ul class="media-list media-list-divider m-0">
                                <li class="media">
                                    <a class="media-img" href="javascript:;">
                                        <img class="img-circle" src="asset/backend/assets/img/users/u1.jpg"
                                            width="40" />
                                    </a>
                                ...
                                <li class="media">
                                    <a class="media-img" href="javascript:;">
                                        <img class="img-circle" src="asset/backend/assets/img/users/u2.jpg"
                                            width="40" />
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a class="media-img" href="javascript:;">
                                        <img class="img-circle" src="asset/backend/assets/img/users/u3.jpg"
                                            width="40" />
                                    </a>
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <a class="media-img" href="javascript:;">
                                        <img class="img-circle" src="asset/backend/assets/img/users/u6.jpg"
                                            width="40" />
                                    </a>
                                    <div class="media-body">
            ...
            <div>
                <a class="adminca-banner" href="http://admincast.com/adminca/" target="_blank">
                    ...
                    <div class="wrap-1">
                        <div class="wrap-2">
                            <div>
                                <img src="asset/backend/assets/img/adminca-banner/adminca-preview.jpg"
                        ...
                        <div style="flex:1;">
                            <div class="d-flex justify-content-end wrap-3">
                                <div class="adminca-banner-b m-r-20">
                                    <img src="asset/backend/assets/img/adminca-banner/bootstrap.png"
                                        style="width:40px;margin-right:10px;" />Bootstrap v4
                                </div>
                                <div class="adminca-banner-b m-r-10">
                                    <img src="asset/backend/assets/img/adminca-banner/angular.png"
